...
static const char qt_meta_stringdata_course[] = {
    "course\0"
};
...
const QMetaObjectExtraData course::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject course::staticMetaObject = {
    { &sub_win::staticMetaObject, qt_meta_stringdata_course,
      qt_meta_data_course, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &course::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_course))
