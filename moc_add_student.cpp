...
static const char qt_meta_stringdata_add_student[] = {
    "add_student\0"
};
...
const QMetaObjectExtraData add_student::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject add_student::staticMetaObject = {
    { &new_student::staticMetaObject, qt_meta_stringdata_add_student,
      qt_meta_data_add_student, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &add_student::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_add_student))
        return static_cast<void*>(const_cast< add_student*>(this));
